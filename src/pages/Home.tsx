  ...
  return (
    <div className="min-h-screen">
      ...
      >
        ...
        {/* DESKTOP QR WIDGET */}
        <div className="hidden md:block absolute bottom-10 right-30 z-20">
          <div className="flex flex-col items-center gap-4 p-4 rounded-2xl shadow-xl">
            ...
            <a
              ...
              className="bg-primary text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-primary-dark transition-all"
            >
              Rate Us On Google
            </a>
          </div>
        ...
        <div className="max-w-7xl mx-auto bg-primary rounded-4xl p-12 md:p-20 relative overflow-hidden">
          ...
          <div className="relative z-10 text-center max-w-3xl mx-auto">
            ...
            <p className="text-white/80 text-lg mb-10">
              Skip the paperwork and complex forms. Message us on WhatsApp and
              get your keys in no time.
            </p>
