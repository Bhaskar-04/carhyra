        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/80 mb-10 leading-relaxed">
              Experience ease and comfort with our perfect fleet. Simple booking, transparent pricing, and exceptional service.
            </p>
            <p className="text-lg md:text-xl text-white/80 mb-10 leading-relaxed">
              Currently Operating in <b><u>Delhi-NCR</u></b> Region Only!!!
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div className="max-w-2xl">
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Our Fleet</h2>
